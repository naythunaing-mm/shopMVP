...
export default function ClientShopsPage({ shops, searchParams }) {
  ...
  const updateSearchParams = useCallback((params) => {
    ...
    router.push(`/shops?${newSearchParams.toString()}`);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="flex mb-8" aria-label="Breadcrumb">
        <ol className="flex items-center space-x-2">
          ...
          <li className="flex items-center">
            ...
            <span className="ml-2 text-gray-900 font-medium">Shops</span>
          </li>
        </ol>
      </nav>
      ...
      {/* Page title */}
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-gray-900">All Shops</h1>
        <p className="mt-2 text-lg text-gray-600">Discover our partner shops and their unique products</p>
      </div>
